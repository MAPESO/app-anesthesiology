          ...
          <Layout>
            <Header>
              <Text style={{ color: '#fff' }}>
                Opcional - Datos del médico responsable
              </Text>
            </Header>
            <View style={{ marginTop: 10, paddingLeft: 15, paddingRight: 15 }}>
              <Label>CFP</Label>
              <FormInput placeholder="Ingrese su número de seguro social" />
              <Label>CRM</Label>
              <FormInput placeholder="Ingrese su CRM" />
              <Label>Nombre</Label>
              <FormInput placeholder="Ingrese su nombre" />
              <Label>Email</Label>
              <FormInput placeholder="Ingrese su email" />
            </View>
          </Layout>
        );
      case 'description':
